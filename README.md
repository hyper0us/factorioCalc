...
# usage
### initialisation
for use simply create object of a class of item you're interested in, as an argument for initialisation change initCraftedPerSecond to destined amount per second
### crafting tree
